...
export const FONT_HEAVY = `'Noto Sans SC', sans-serif`;
export const FONT_TECH = `'Exo 2', 'Helvetica Neue', sans-serif`; 
export const FONT_WIDE = `'Audiowide', 'Orbitron', sans-serif`; 
export const FONT_ORB = `'Orbitron', 'Audiowide', sans-serif`; 
...
export const LANG = VIDEO.lang;

export const SQUEEZE = 1;

export const TEXT_DY = 0;
