#!/usr/bin/env python3
"""Fail-closed production dependency checks for the Copilot Studio 2026 project."""
...
def timeline_status() -> tuple[bool, list[str]]:
    ...
    if not path.is_file():
        return True, ['script/timeline.json not generated yet; run npm run audio after dependencies pass.']
    try:
...
def main() -> None:
    ...
    timeline_ok, timeline_detail = timeline_status()
