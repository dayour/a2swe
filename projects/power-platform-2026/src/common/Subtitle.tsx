...
export const SUB_STYLE = {fontSize: 42, weight: 700, top: 950, color: '#FFFFFF', stroke: 4, strokeColor: '#000000'};
export const SUB_MAX_W = 1640; 
...
export const SubtitleLine: React.FC<{text: string; top?: number; left?: number; color?: string; stroke?: number}> = ({text, top = SUB_STYLE.top, left = 960, color = SUB_STYLE.color, stroke = SUB_STYLE.stroke}) => {
