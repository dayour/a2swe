...
| --- | --- | --- |
| Duration and scope | Pending | Not yet requested |
...
| --- | --- | --- | --- |
| 0 Scaffold | Project destination | Not started | Pending |
| 1 Research | Topic / source material | Not started | Pending |
| 2 Narration and timeline | Research; duration/scope; narration and voiceover approvals before TTS | Not started | Pending |
| 3 Storyboard | Locked narration and timeline | Not started | Pending |
| 4 Overlays and primitives | Storyboard and visual rules | Not started | Pending |
| 5a Pilot | Overlays and first shot group | Not started | Pending |
| 5b Parallel shot build | Pilot approval | Not started | Pending |
| 6 Render | Integrated shots and passing typecheck | Not started | Pending |
| 7 QC and fixes | Render and storyboard evidence | Not started | Pending |
| 8 Delivery | QC disposition; video, sources, and populated companion artifact | Not started | Pending |

## Domain Knowledge and Reuse

- Verified facts, source URLs, verification dates, and uncertainties: pending research
- English glossary and pronunciation: pending
- Reusable diagrams, components, visual rules, and example context: pending
- Image/footage provenance, licenses, and manifest paths: pending; no external assets assumed
- Decisions, alternatives, and reasons: pending
...
| Approved narration | Pending | Pending |
...
- Current next action: initialize the project brief and stage 0 record.
- Outstanding issues / known limitations: starter artifact; no video has been produced or validated.
