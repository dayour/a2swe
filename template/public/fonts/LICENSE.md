...
The four bundled fonts are distributed under **SIL Open Font License, Version 1.1**.
Copyright notices and reserved font names from the font metadata follow.

| File | Font | Copyright notice |
|---|---|---|
...
The OFL permits use, embedding, modification, and redistribution, including with
commercial software. Fonts may not be sold by themselves. Preserve notices and
this license when redistributing; modified versions must respect reserved names.
Rendered documents and videos are not subject to the font license.
